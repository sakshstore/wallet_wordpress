...
if($type=='debit'){
 $res=credit($current_user_id, $amount, $currency, $description);
 $res=debit($user_id, $amount, $currency, $description);
}

else{
  $res=credit($user_id, $amount, $currency, $description);
   $res=debit($current_user_id, $amount, $currency, $description);
}
